...
<body class="bg-dark">
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      ...
      <form:errors path="account.*" style="color:red"/>
      <div class="card-body">
        <form action="/mvc/register" method="post">
          ...
          <div class="form-group">
              ...
              <div class="col-md-6">
                ...
                <input class="form-control" id="exampleInputLastName" type="text" aria-describedby="nameHelp" placeholder="Enter Phone" name="phoneNumber">
              </div>
            </div>
          ...
          <div class="form-group">
            <div class="form-row">
              ...
              <div class="col-md-6">
                ...
                <input class="form-control" id="exampleConfirmPassword" type="password" placeholder="Confirm password" name="confirmPassword">
              </div>
            </div>
          </div>
          <input type="submit" class="btn btn-primary btn-block" value="Register"></input>
        </form>
